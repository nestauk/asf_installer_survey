...
# Define function
make_graph_count <- function(var, caption, breakline) {
...
```{r}
### OBQA
data |> tabyl(x12c_all_installers, x12a_thinking_of_your_companys_overall_heating_work_what_does_it_currently_consist_of)

data |> tabyl(x12c_all_installers, x12b_thinking_of_your_overall_heating_work_what_does_it_currently_consist_of)
