---
title: "Installer survey - Section 4 (v2)"
...
data <- data %>% 
  mutate(dummy_no_installs_owners = ifelse(str_detect(x31a_answer1, fixed("I haven’t done any installations")) |
                                     str_detect(x31a_answer2, fixed("I haven’t done any installations")) |
                                     str_detect(x31a_answer3, fixed("I haven’t done any installations")) |
                                     str_detect(x31a_answer4, fixed("I haven’t done any installations")), 1, 0))
data <- data %>% 
  mutate(dummy_not_relevant_owners = ifelse(str_detect(x31a_answer1, fixed("Other - not relevant")) |
                                     str_detect(x31a_answer2, fixed("Other - not relevant")) |
                                     str_detect(x31a_answer3, fixed("Other - not relevant")) |
                                     str_detect(x31a_answer4, fixed("Other - not relevant")), 1, 0))
data <- data %>% 
...
subset_dummy <- data %>%
  select(dummy_private_homes_owners, dummy_social_housing_owners, dummy_commercial_properties_owners, dummy_no_installs_owners, dummy_not_relevant_owners, dummy_other_owners)
...
# Export csv
export_to_csv(summary_table, "plot_4.3a.csv")
...
ggplot(gather(summary_table), aes(x = reorder(key, -value), y = value)) +
  ...
  labs(title = "Figure 4.3a. Distribution of property types for retrofit (company owners)", x = "", y = "Count") +
  theme_bw() +
...
data <- data %>% 
  mutate(dummy_no_installs_others = ifelse(str_detect(x31b_answer1, fixed("I haven’t done any installations")) |
                                     str_detect(x31b_answer2, fixed("I haven’t done any installations")) |
                                     str_detect(x31b_answer3, fixed("I haven’t done any installations")) |
                                     str_detect(x31b_answer4, fixed("I haven’t done any installations")), 1, 0))
data <- data %>% 
...
# Create a new dataframe with only the dummy variables above
subset_dummy <- data %>%
  select(dummy_private_homes_others, dummy_social_housing_others, dummy_commercial_properties_others, dummy_no_installs_others, dummy_other_others)
...
# Export csv
export_to_csv(summary_table, "plot_4.3b.csv")

# Plot
ggplot(gather(summary_table), aes(x = reorder(key, -value), y = value)) +
  geom_bar(stat = "identity", fill = "blue") +
  geom_text(aes(label = value), position = position_dodge(width = 0.9), vjust = -0.4, size = 3) +
  labs(title = "Figure 4.3b. Distribution of property types for retrofit (sole traders, employees \nand contractors)", x = "", y = "Count") +
  theme_bw() +
...
data <- data %>% 
  mutate(dummy_no_installs_all = coalesce(dummy_no_installs_owners, dummy_no_installs_others))
data <- data %>% 
  mutate(dummy_other_all = coalesce(dummy_other_owners, dummy_other_others))

# Create a new dataframe with only the dummy variables above
subset_dummy <- data %>%
  select(dummy_private_homes_all, dummy_social_housing_all, dummy_commercial_properties_all, dummy_no_installs_all, dummy_other_all)
...
# Export csv
export_to_csv(summary_table, "plot_4.3c.csv")

# Plot
ggplot(gather(summary_table), aes(x = reorder(key, -value), y = value)) +
  geom_bar(stat = "identity", fill = "blue") +
  geom_text(aes(label = value), position = position_dodge(width = 0.9), vjust = -0.7, size = 3) +
  labs(title = "Figure 4.3c. Distribution of property types for retrofit (all installers)", x = "", y = "Count") +
  theme_bw() +
...
# Create a new dataframe with only the dummy variables above
subset_dummy <- data %>%
  select(dummy_private_homes_all, dummy_social_housing_all, dummy_commercial_properties_all, dummy_no_installs_all, dummy_other_all, employment_type)
...
# Export csv
export_to_csv(summary_table, "plot_4.3d.csv")
...
subset_dummy <- subset_question %>%
  select(dummy_private_homes_all, dummy_social_housing_all, dummy_commercial_properties_all, dummy_no_installs_all, dummy_other_all, size_company_owned_collapsed_1)
...
# Export csv
export_to_csv(summary_table, "plot_4.4a.csv")
...
# Create a new dataframe with only the dummy variables above
subset_dummy <- subset_question %>%
  select(dummy_private_homes_all, dummy_social_housing_all, dummy_commercial_properties_all, dummy_other_all, dummy_no_installs_all, size_company_employee_work_1)
...
# Export csv
export_to_csv(summary_table, "plot_4.4b.csv")
...
data <- data %>% 
  mutate(dummy_no_installs_owners = ifelse(str_detect(x32a_answer1, fixed("I haven’t done any installations")) |
                                     str_detect(x32a_answer2, fixed("I haven’t done any installations")) |
                                     str_detect(x32a_answer3, fixed("I haven’t done any installations")) |
                                     str_detect(x32a_answer4, fixed("I haven’t done any installations")), 1, 0))
data <- data %>% 
...
# Create a new dataframe with only the dummy variables above
subset_dummy <- data %>%
  select(dummy_private_homes_owners, dummy_multiple_homes_owners, dummy_social_housing_owners, dummy_commercial_properties_owners, dummy_no_installs_owners, dummy_other_owners)
...
# Export csv
export_to_csv(summary_table_2, "plot_4.5a.csv")
...
data <- data %>% 
  mutate(dummy_no_installs_others = ifelse(str_detect(x32b_answer1, fixed("I haven’t done any installations")) |
                                     str_detect(x32b_answer2, fixed("I haven’t done any installations")) |
                                     str_detect(x32b_answer3, fixed("I haven’t done any installations")) |
                                     str_detect(x32b_answer4, fixed("I haven’t done any installations")), 1, 0))
data <- data %>% 
...
# Create a new dataframe with only the dummy variables above
subset_dummy <- data %>%
  select(dummy_private_homes_others, dummy_multiple_homes_others, dummy_social_housing_others, dummy_commercial_properties_others, dummy_no_installs_others, dummy_other_others)
...
# Export csv
export_to_csv(summary_table_2, "plot_4.5b.csv")
...
# Create a new dataframe with only the dummy variables above
subset_dummy <- data %>%
  select(dummy_private_homes_all, dummy_multiple_homes_all, dummy_social_housing_all, dummy_commercial_properties_all, dummy_no_installs_all, dummy_other_all)
...
# Export csv
export_to_csv(summary_table_2, "plot_4.5c.csv")
...
# Create a new dataframe with only the dummy variables above
subset_dummy <- data %>%
  select(dummy_private_homes_all, dummy_multiple_homes_all, dummy_social_housing_all, dummy_commercial_properties_all, dummy_other_all, dummy_no_installs_all, employment_type)
...
# Export csv
export_to_csv(summary_table, "plot_4.5d.csv")
...
# Create a new dataframe with only the dummy variables above
subset_dummy <- subset_question %>%
  select(dummy_private_homes_all, dummy_multiple_homes_all, dummy_social_housing_all, dummy_commercial_properties_all, dummy_other_all, dummy_no_installs_all, size_company_owned_collapsed_1)
...
# Export csv
export_to_csv(summary_table, "plot_4.6a.csv")
...
# Create a new dataframe with only the dummy variables above
subset_dummy <- subset_question %>%
  select(dummy_private_homes_all, dummy_multiple_homes_all, dummy_social_housing_all, dummy_commercial_properties_all, dummy_no_installs_all, dummy_other_all, size_company_employee_work_1)
...
# Export csv
export_to_csv(summary_table, "plot_4.6b.csv")
...
# Export to csv
plot_4.9c <- generate_table(data_filtered, "employment_type", "x34_all")
export_to_csv(plot_4.9c, "plot_4.9c.csv")
```
...
# Export to csv
plot_4.10a <- generate_table(subset_question, "size_company_owned_collapsed_1", "x34_all")
export_to_csv(plot_4.10a, "plot_4.10a.csv")
```
...
# Export to csv
plot_4.10b <- generate_table(subset_question, "size_company_employee_work_1", "x34_all")
export_to_csv(plot_4.10b, "plot_4.10b.csv")
```
...
# Export to csv
plot_4.11c <- generate_table(data, "employment_type", "x35_all")
export_to_csv(plot_4.11c, "plot_4.11c.csv")
```
...
# Export to csv
plot_4.12a <- generate_table(subset_question, "size_company_owned_collapsed_1", "x35_all")
export_to_csv(plot_4.12a, "plot_4.12a.csv")
```
...
# Export to csv
plot_4.12b <- generate_table(subset_question, "size_company_employee_work_1", "x35_all")
export_to_csv(plot_4.12b, "plot_4.12b.csv")
```
...
data <- data %>% 
  mutate(dummy_no_installs_owners = ifelse(str_detect(x36a_answer1, fixed("I haven’t done any installations")) |
                                     str_detect(x36a_answer2, fixed("I haven’t done any installations")) |
                                     str_detect(x36a_answer3, fixed("I haven’t done any installations")), 1, 0))
...
# Create a new dataframe with only the dummy variables above
subset_dummy <- data %>%
  select(dummy_MCS_certified_owners, dummy_sign_off_owners, dummy_umbrella_scheme_owners, dummy_without_MCS_owners, dummy_no_installs_owners, dummy_other_owners, dummy_dont_know_owners)
...
# Export csv
export_to_csv(summary_table_2, "plot_4.13a.csv")
...
data <- data %>% 
  mutate(dummy_no_installs_traders = ifelse(str_detect(x36b_answer1, fixed("I haven’t done any installations")) |
                                      str_detect(x36b_answer2, fixed("I haven’t done any installations")), 1, 0))
...
# Create a new dataframe with only the dummy variables above
subset_dummy <- data %>%
  select(dummy_MCS_certified_traders, dummy_sign_off_traders, dummy_umbrella_scheme_traders, dummy_without_MCS_traders, dummy_no_installs_traders, dummy_other_traders, dummy_dont_know_traders)
...
# Export csv
export_to_csv(summary_table_2, "plot_4.13b.csv")
...
ggplot(summary_table_2, aes(x = answers, y = count)) +
  ...
  scale_x_discrete(labels = label_wrap_gen(width = 13))
```
...
data <- data %>% 
  mutate(dummy_no_installs_employees = ifelse(str_detect(x36c_answer1, fixed("I haven’t done any installations")) |
                                        str_detect(x36c_answer2, fixed("I haven’t done any installations")), 1, 0))
...
# Create a new dataframe with only the dummy variables above
subset_dummy <- data %>%
  select(dummy_MCS_certified_employees, dummy_firm_certification_employees, dummy_umbrella_scheme_employees, dummy_without_MCS_employees, dummy_no_installs_employees, dummy_other_employees, dummy_dont_know_employees)
...
# Export csv
export_to_csv(summary_table_2, "plot_4.13c.csv")
...
data <- data %>% 
  mutate(dummy_no_installs_contractors = ifelse(str_detect(x36d_answer1, fixed("I haven’t done any installations")) |
                                          str_detect(x36d_answer2, fixed("I haven’t done any installations")), 1, 0))
...
# Create a new dataframe with only the dummy variables above
subset_dummy <- data %>%
  select(dummy_MCS_certified_contractors, dummy_firm_certification_contractors, dummy_umbrella_scheme_contractors, dummy_without_MCS_contractors, dummy_no_installs_contractors, dummy_other_contractors, dummy_dont_know_contractors)
...
# Export csv
export_to_csv(summary_table_2, "plot_4.13d.csv")
...
# No installation
data <- data %>% 
  mutate(dummy_no_installs_both = case_when(  
    dummy_no_installs_owners == 1 ~ 1,
    dummy_no_installs_traders == 1 ~ 1,
    TRUE ~ NA_integer_))
...
# Subset company owners and sole traders
subset_question <- data %>% 
  select(employment_type, dummy_own_MCS_both, dummy_umbrella_scheme_both_merged, dummy_wihout_MCS_both, dummy_no_installs_both, dummy_other_both, dummy_dont_know_both)
...
# Export csv
export_to_csv(summary_table, "plot_4.13e.csv")
...
subset_question <- data %>% 
  filter(employment_type %in% c("Sole trader", "Company owner")) %>% 
  select(size_company_owned_collapsed_1, dummy_own_MCS_both, dummy_sign_off_both, dummy_umbrella_scheme_both, dummy_wihout_MCS_both, dummy_no_installs_both, dummy_other_both, dummy_dont_know_both)
...
# Export csv
export_to_csv(summary_table, "plot_4.14a.csv")
...
subset_question <- data %>% 
  filter(employment_type %in% c("Sole trader", "Company owner")) %>% 
  select(size_company_owned_collapsed_1, dummy_own_MCS_both, dummy_umbrella_scheme_both_merged, dummy_wihout_MCS_both, dummy_no_installs_both, dummy_other_both, dummy_dont_know_both)
...
# Export csv
export_to_csv(summary_table, "plot_4.14b.csv")
...
subset_question <- data %>% 
  filter(employment_type == "Employee") %>% 
  select(size_company_employee_work_1, dummy_MCS_certified_employees, dummy_firm_certification_employees, dummy_umbrella_scheme_employees, dummy_without_MCS_employees, dummy_no_installs_employees, dummy_other_employees, dummy_dont_know_employees)
...
# Export csv
export_to_csv(summary_table, "plot_4.14c.csv")
...
data <- data %>% 
  mutate(dummy_other_others = ifelse(str_detect(x31b_answer1, fixed("Other")) |
                                       ...
                                       str_detect(x31b_answer4, fixed("Other")), 1, 0))
data <- data %>% 
  mutate(dummy_not_relevant_others = ifelse(str_detect(x31b_answer1, fixed("Other - not relevant")) |
                                       str_detect(x31b_answer2, fixed("Other - not relevant")) |
                                       str_detect(x31b_answer3, fixed("Other - not relevant")) |
                                       str_detect(x31b_answer4, fixed("Other - not relevant")), 1, 0))
...
data <- data %>% 
  mutate(dummy_other_all = coalesce(dummy_other_owners, dummy_other_others))
data <- data %>% 
  mutate(dummy_not_relevant_all = coalesce(dummy_not_relevant_owners, dummy_not_relevant_others))


# Subset work type
subset_question <- data %>% 
  filter(retrofit_newbuild_all %in% c("Retrofit only", "Both retrofit and new build")) %>% 
  select(retrofit_newbuild_all, dummy_private_homes_all, dummy_social_housing_all, dummy_commercial_properties_all, dummy_no_installs_all, dummy_other_all, dummy_not_relevant_all)
...
# Export csv
export_to_csv(summary_table, "plot_4.15a.csv")
...
subset_question <- data %>% 
  ...
  select(retrofit_newbuild_all, dummy_private_homes_all, dummy_multiple_homes_all, dummy_social_housing_all, dummy_commercial_properties_all, dummy_no_installs_all, dummy_other_all)
...
# Export csv
export_to_csv(summary_table, "plot_4.16a.csv")
