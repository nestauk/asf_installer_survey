...
ggplot(data_filtered, aes(x = x13b_thinking_of_your_overall_heating_work_in_12_months_time_what_do_you_intend_it_to_consist_of_bis)) +
  geom_bar(fill = "blue") +
  labs(title = "Figure 2.2b. Type of heating work in the next 12 months (sole traders, \nemployees, contractors)", 
       x = "", 
       y = "Count") +
  theme_bw() +
  scale_y_continuous(breaks = seq(0, 100, by = 20)) +
...
ggplot(table_long, aes(x = factor(`Installations`, levels = order_labels), y = Frequency, fill = EmploymentType)) +
  ...
  labs(title = "Figure 2.6b. Distribution of the different heating systems installations by \nemployment type",
       x = "",
       y = "Frequency",
...
ggplot(table_long, aes(x = factor(`Installations`, levels = order_labels), y = Frequency, fill = EmploymentType)) +
  geom_bar(stat = "identity", position = "dodge") +
  labs(title = "Figure 2.6c. Distribution of the different heating systems installations by \nemployment type",
       x = "",
       y = "Frequency",
       fill = "Employment type") +
  theme_bw() +
...
ggplot(table_long, aes(x = factor(`Installations`, levels = order_labels), y = Frequency, fill = EmploymentType)) +
  geom_bar(stat = "identity", position = "dodge") +
  labs(title = "Figure 2.6e. Distribution of the different heating systems installations by \nemployment type",
       x = "",
       y = "Frequency",
       fill = "Employment type") +
  theme_bw() +
...
ggplot(table_long, aes(x = factor(`Installations`, levels = order_labels), y = Frequency, fill = EmploymentType)) +
  geom_bar(stat = "identity", position = "dodge") +
  labs(title = "Figure 2.6f. Distribution of the different heating systems installations by \nemployment type",
       x = "",
       y = "Frequency",
       fill = "Employment type") +
  theme_bw() +
...
ggplot(data, aes(x = service_maintenance_merge)) +
  geom_bar(fill = "blue") +
  labs(title = "Figure 2.7a. Distribution of the different heating systems service and \nmaintenance (all installers)", 
       x = "", 
       y = "Count") +
  theme_bw() +
  scale_y_continuous(breaks = seq(0, 120, by = 20)) +
...
ggplot(table_long, aes(x = factor(`Service and maintenance`, levels = order_labels), y = Frequency, fill = EmploymentType)) +
  geom_bar(stat = "identity", position = "dodge") +
  labs(title = "Figure 2.7b. Distribution of the different heating systems service and \nmaintenance by employment type",
       x = "",
       y = "Frequency",
       fill = "Employment type") +
  theme_bw() +
...
ggplot(table_long, aes(x = factor(`Service and maintenance`, levels = order_labels), y = Frequency, fill = EmploymentType)) +
  geom_bar(stat = "identity", position = "dodge") +
  labs(title = "Figure 2.7c. Distribution of the different heating systems service and maintenance \nby employment type",
       x = "",
       y = "Frequency",
       fill = "Employment type") +
  theme_bw() +
...
# Water-source heat pump
data <- data %>% 
  mutate(dummy_no_installs_16a = ifelse(str_detect(x16a_answer1, "I haven’t done any installations") |
                                   str_detect(x16a_answer2, "I haven’t done any installations") |
                                   str_detect(x16a_answer3, "I haven’t done any installations") |
                                   str_detect(x16a_answer4, "I haven’t done any installations") |
                                   str_detect(x16a_answer5, "I haven’t done any installations") |
                                   str_detect(x16a_answer6, "I haven’t done any installations") |
                                   str_detect(x16a_answer7, "I haven’t done any installations"), 1, 0))
...
data <- data %>% 
  mutate(dummy_no_installs_16b = ifelse(str_detect(x16b_answer1, "I haven’t done any installations") |
                                   str_detect(x16b_answer2, "I haven’t done any installations") |
                                   str_detect(x16b_answer3, "I haven’t done any installations") |
                                   str_detect(x16b_answer4, "I haven’t done any installations") |
                                   str_detect(x16b_answer5, "I haven’t done any installations") |
                                   str_detect(x16b_answer6, "I haven’t done any installations") |
                                   str_detect(x16b_answer7, "I haven’t done any installations") |
                                   str_detect(x16b_answer8, "I haven’t done any installations") |
                                   str_detect(x16b_answer9, "I haven’t done any installations"), 1, 0))
...
data <- data %>% 
  mutate(dummy_no_installs_all = coalesce(dummy_no_installs_16a, dummy_no_installs_16b))
data <- data %>% 
...
subset_dummy <- data %>%
  select("dummy_air_source_all", "dummy_air_air_all", "dummy_ground_source_all", "dummy_hybrid_air_source_all", "dummy_hybrid_ground_source_all", "dummy_ground_loops_all", "dummy_communal_heating_all", "dummy_water_source_all", "dummy_no_installs_all", "dummy_other_all")
...
kable(summary_table,
      ...
      col.names = c("Ways of working", "Count"),
      align = "c") %>%
  kable_classic(lightable_options = c("striped"),
                full_width = T,
                html_font = "Arial") %>%
...
# Export csv
plot_2.8a <- summary_long
export_to_csv(plot_2.8a, "plot_2.8a.csv")

# Produce plot
ggplot(plot_2.8a, aes(x = factor(dummy_variable, levels = c("Air-source (air-to-water) heat pumps", 
               "Air-to-air heat pumps", 
               "Ground-source heat pumps", 
               "Hybrid air-source heat pumps", 
               "Hybrid ground-source heat pumps", 
  ...
  labs(title = "Figure 2.8a. The types of heat pumps have survey participants installed over the last\n 12 months (all installers)", x = "", y = "Count") +
  theme_bw() +
  scale_y_continuous(breaks = seq(0, 340, by = 40)) +
  scale_x_discrete(labels = label_wrap_gen(width = 10))
```

Tables and Figures 2.8b to 2.8e show the distribution for different employment type: sole traders, company owners, employees and contractors.
...
# Export csv
plot_2.8b <- summary_long_1
export_to_csv(plot_2.8b, "plot_2.8b.csv")

# Produce plot
ggplot(plot_2.8b, aes(x = factor(dummy_variable, levels = c("Air-source (air-to-water) heat pumps", 
               "Air-to-air heat pumps", 
               "Ground-source heat pumps", 
               "Hybrid air-source heat pumps", 
               "Hybrid ground-source heat pumps", 
               ...
               "Other")), y = count)) +
  geom_bar(stat = "identity", fill = "blue") +
  labs(title = "Figure 2.8b. The types of heat pumps have survey participants installed over the last \n12 months (sole traders)", x = "", y = "Count") +
  theme_bw() +
...
# Export csv
plot_2.8c <- summary_long_2
export_to_csv(plot_2.8c, "plot_2.8c.csv")
...
ggplot(summary_long_2, aes(x = factor(dummy_variable, levels = c("Air-source (air-to-water) heat pumps", 
               ...
               "Other")), y = count)) +
  geom_bar(stat = "identity", fill = "blue") +
  labs(title = "Figure 2.8c. The types of heat pumps have survey participants installed over the last \n12 months (company owners)", x = "", y = "Count") +
  theme_bw() +
...
# Export csv
plot_2.8d <- summary_long_3
export_to_csv(plot_2.8d, "plot_2.8d.csv")

# Produce plot
ggplot(plot_2.8d, aes(x = factor(dummy_variable, levels = c("Air-source (air-to-water) heat pumps", 
               "Air-to-air heat pumps", 
               "Ground-source heat pumps", 
               "Hybrid air-source heat pumps", 
               "Hybrid ground-source heat pumps", 
               ...
               "Other")), y = count)) +
  geom_bar(stat = "identity", fill = "blue") +
  labs(title = "Figure 2.8d. The types of heat pumps have survey participants installed over the last \n12 months (employees)", x = "", y = "Count") +
  theme_bw() +
...
# Export csv
plot_2.8e <- summary_long_4
export_to_csv(plot_2.8e, "plot_2.8e.csv")

# Produce plot
ggplot(plot_2.8e, aes(x = factor(dummy_variable, levels = c("Air-source (air-to-water) heat pumps", 
               "Air-to-air heat pumps", 
               "Ground-source heat pumps", 
               "Hybrid air-source heat pumps", 
               "Hybrid ground-source heat pumps", 
               ...
               "Other")), y = count)) +
  geom_bar(stat = "identity", fill = "blue") +
  labs(title = "Figure 2.8e. The types of heat pumps have survey participants installed over the last \n12 months (contractors)", x = "", y = "Frequency") +
  theme_bw() +
  scale_y_continuous(breaks = seq(0, 40, by = 5)) +
  scale_x_discrete(labels = label_wrap_gen(width = 10))
```
...
data$x17c_all_installers <- as.factor(data$x17c_all_installers)
...
kable(table, 
      ...
      col.names = c("Type of heat pump", "Count"), 
      align = "c") %>%
  kable_classic(lightable_options = c("striped"),
                full_width = F,
                html_font = "Arial") %>%
...
# Export csv
plot_2.9a <- table
export_to_csv(plot_2.9a, "plot_2.9a.csv")
```
...
# Export csv
export_to_csv(table_df, "plot_2.9b.csv")
...
ggplot(table_long, aes(x = factor(`Heat batteries`, levels = order_labels), y = Frequency, fill = EmploymentType)) +
  geom_bar(stat = "identity", position = "dodge") +
  labs(title = "Figure 2.10c. Heat batteries offered to accompany heat pumps by employment \ntype (binary)",
       x = "",
       y = "Count",
       fill = "Employment type") +
  theme_bw() +
...
ggplot(summary_long, aes(x = factor(dummy_variable, levels = c("Lack of customer demand",
               ...
               "Don't know")), y = count)) +
  geom_bar(stat = "identity", fill = "blue") +
  labs(title = "Figure 2.11a. Barriers to providing heat batteries (all installers)", x = "", y = "Count") +
  theme_bw() +
  scale_y_continuous(breaks = seq(0, 120, by = 20)) +
  scale_x_discrete(labels = label_wrap_gen(width = 10))
```
...
ggplot(summary_long_1, aes(x = factor(dummy_variable, levels = c("Lack of customer demand",
               ...
               "Don't know")), y = count)) +
  geom_bar(stat = "identity", fill = "blue") +
  labs(title = "Figure 2.11b. Barriers to providing heat batteries (sole traders)", x = "", y = "Count") +
  theme_bw() +
  scale_y_continuous(breaks = seq(0, 40, by = 5)) +
  scale_x_discrete(labels = label_wrap_gen(width = 10))
```
...
ggplot(summary_long_2, aes(x = factor(dummy_variable, levels = c("Lack of customer demand",
               ...
               "Don't know")), y = count)) +
  geom_bar(stat = "identity", fill = "blue") +
  labs(title = "Figure 2.11c. Barriers to providing heat batteries (company owners)", x = "", y = "Count") +
  theme_bw() +
...
ggplot(summary_long_3, aes(x = factor(dummy_variable, levels = c("Lack of customer demand",
               ...
               "Don't know")), y = count)) +
  geom_bar(stat = "identity", fill = "blue") +
  labs(title = "Figure 2.11d. Barriers to providing heat batteries (employees)", x = "", y = "Count") +
  theme_bw() +
  scale_y_continuous(breaks = seq(0, 40, by = 5)) +
  scale_x_discrete(labels = label_wrap_gen(width = 10))
```
...
ggplot(summary_long_4, aes(x = factor(dummy_variable, levels = c("Lack of customer demand",
               ...
               "Don't know")), y = count)) +
  geom_bar(stat = "identity", fill = "blue") +
  labs(title = "Figure 2.11e. Barriers to providing heat batteries (contractors)", x = "", y = "Count") +
  theme_bw() +
...
kable(table, 
      ...
      col.names = c("Hot water systems", "Count"), 
      align = "c") %>%
  kable_classic(lightable_options = c("striped"),
                full_width = F,
                html_font = "Arial") %>%
...
ggplot(data, aes(x = x20_if_a_customer_doesn_t_specify_what_they_want_with_their_heat_pump_what_is_the_most_important_factor_for_you_when_choosing_which_thermal_store_or_hot_water_system_to_fit_please_select_one_option)) +
  geom_bar(fill = "blue") +
  labs(title = "Figure 2.12a. Most important factor when choosing most appropriate hot water \nsystem (all installers)", 
       x = "", 
       y = "Count") +
  theme_bw() +
...
ggplot(table_long, aes(x = factor(`Important factor`, levels = order_labels), y = Frequency, fill = EmploymentType)) +
  geom_bar(stat = "identity", position = "dodge") +
  labs(title = "Figure  2.12b. Most important factor when choosing most appropriate hot water \nsystem by employment type",
       x = "",
       y = "Count",
       fill = "Employment type") +
  theme_bw() +
...
ggplot(table_long, aes(x = factor(`Important factor`, levels = order_labels), y = Frequency, fill = EmploymentType)) +
  geom_bar(stat = "identity", position = "dodge") +
  labs(title = "Figure 2.12c. Most important factor when choosing most appropriate hot water \nsystem by employment type (binary)",
       x = "",
       y = "Count",
       fill = "Employment type") +
  theme_bw() +
